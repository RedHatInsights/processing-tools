...
|----------|--------|-------|------|
| #3852013 | 5,165 | AttributeError: 'NoneType' object has no attribute 'start... | [View](https://glitchtip.devshift.net/ccx/issues/3852013) |
| #3852210 | 3,927 | AttributeError: 'str' object has no attribute 'parent' | [View](https://glitchtip.devshift.net/ccx/issues/3852210) |
...
| Issue ID | Events | Title | Link |
|----------|--------|-------|------|
| #4319957 | 1,180 | ParseException: ccx_ocp_core.parsers.insights_operator.co... | [View](https://glitchtip.devshift.net/ccx/issues/4319957) |
...
| Issue ID | Events | Title | Link |
|----------|--------|-------|------|
| #4319955 | 1,179 | ParseException: ccx_ocp_core.parsers.insights_operator.co... | [View](https://glitchtip.devshift.net/ccx/issues/4319955) |
...
| Issue ID | Events | Title | Link |
|----------|--------|-------|------|
| #3781153 | 5,592 | AttributeError: 'NoneType' object has no attribute 'start... | [View](https://glitchtip.devshift.net/ccx/issues/3781153) |
| #3791585 | 4,156 | AttributeError: 'str' object has no attribute 'parent' | [View](https://glitchtip.devshift.net/ccx/issues/3791585) |
...
| Issue ID | Events | Title | Link |
|----------|--------|-------|------|
| #4319956 | 1,179 | ParseException: ccx_ocp_core.parsers.insights_operator.co... | [View](https://glitchtip.devshift.net/ccx/issues/4319956) |
...
| Issue ID | Events | Title | Link |
|----------|--------|-------|------|
| #4249305 | 111 | FileExpired: [Errno 16] The remote file corresponding to ... | [View](https://glitchtip.devshift.net/ccx/issues/4249305) |
