...
- [ccx-data-pipeline](#ccx-data-pipeline) - 3 groups, 19 issues
- [ccx-notification-service](#ccx-notification-service) - 1 groups, 2 issues
- [ccx-notification-writer](#ccx-notification-writer) - 1 groups, 4 issues
- [ccx-upgrades-data-eng](#ccx-upgrades-data-eng) - 1 groups, 2 issues
- [dvo-extractor](#dvo-extractor) - 2 groups, 8 issues
...
- [rules-processing](#rules-processing) - 4 groups, 148 issues
...
|----------|--------|-------|------|
| #3852210 | 3,656 | AttributeError: 'str' object has no attribute 'parent' | [View](https://glitchtip.devshift.net/ccx/issues/3852210) |
| #3852013 | 4,615 | AttributeError: 'NoneType' object has no attribute 'start... | [View](https://glitchtip.devshift.net/ccx/issues/3852013) |
...
| Issue ID | Events | Title | Link |
|----------|--------|-------|------|
| #4319957 | 963 | ParseException: ccx_ocp_core.parsers.insights_operator.co... | [View](https://glitchtip.devshift.net/ccx/issues/4319957) |
...
### 🟢 LOW: ValueError: xyz is not valid SemVer string

**Issues:** 6 | **Total Events:** 0

| Issue ID | Events | Title | Link |
|----------|--------|-------|------|
| #3851917 | 8,199 | ValueError: 4.10 is not valid SemVer string | [View](https://glitchtip.devshift.net/ccx/issues/3851917) |
| #4471409 | 12 | ValueError: xyz is not valid SemVer string | [View](https://glitchtip.devshift.net/ccx/issues/4471409) |
| #4472540 | 12 | ValueError: 4.21 is not valid SemVer string | [View](https://glitchtip.devshift.net/ccx/issues/4472540) |
| #4472551 | 6 | ValueError: 4.3 is not valid SemVer string | [View](https://glitchtip.devshift.net/ccx/issues/4472551) |
| #4472542 | 18 | ValueError: 4.7 is not valid SemVer string | [View](https://glitchtip.devshift.net/ccx/issues/4472542) |
| #4471406 | 6 | ValueError: 4.23 is not valid SemVer string | [View](https://glitchtip.devshift.net/ccx/issues/4471406) |

**Recommendation:** Consider merging into [#3851917](https://glitchtip.devshift.net/ccx/issues/3851917) (highest event count)
...
| Issue ID | Events | Title | Link |
|----------|--------|-------|------|
| #3997223 | 280 | Error: Post \"http://insights-content-template-renderer-s... | [View](https://glitchtip.devshift.net/ccx/issues/3997223) |
| #4519036 | 5 | Error: Get \"http://ccx-insights-content-service:10000/ap... | [View](https://glitchtip.devshift.net/ccx/issues/4519036) |
...
| Issue ID | Events | Title | Link |
|----------|--------|-------|------|
| #4506737 | 1 | kafka: error while consuming ccx.ocp.results/0: EOF | [View](https://glitchtip.devshift.net/ccx/issues/4506737) |
| #4494281 | 1 | kafka: error while consuming ccx.ocp.results/0: read tcp ... | [View](https://glitchtip.devshift.net/ccx/issues/4494281) |
| #4491664 | 2 | kafka: error while consuming ccx.ocp.results/0: kafka ser... | [View](https://glitchtip.devshift.net/ccx/issues/4491664) |
| #4434839 | 10 | kafka: error while consuming ccx.ocp.results/0: dial tcp ... | [View](https://glitchtip.devshift.net/ccx/issues/4434839) |
...
| Issue ID | Events | Title | Link |
|----------|--------|-------|------|
| #4466472 | 22 | ConnectionError: HTTPConnectionPool(host='ccx-upgrades-in... | [View](https://glitchtip.devshift.net/ccx/issues/4466472) |
| #4466473 | 12 | ConnectionError: HTTPConnectionPool(host='ccx-upgrades-in... | [View](https://glitchtip.devshift.net/ccx/issues/4466473) |
...
| Issue ID | Events | Title | Link |
|----------|--------|-------|------|
| #4319955 | 962 | ParseException: ccx_ocp_core.parsers.insights_operator.co... | [View](https://glitchtip.devshift.net/ccx/issues/4319955) |
...
| Issue ID | Events | Title | Link |
|----------|--------|-------|------|
| #3979080 | 4,602 | ValueError: 4.10 is not valid SemVer string | [View](https://glitchtip.devshift.net/ccx/issues/3979080) |
| #4471407 | 6 | ValueError: xyz is not valid SemVer string | [View](https://glitchtip.devshift.net/ccx/issues/4471407) |
| #4472539 | 6 | ValueError: 4.21 is not valid SemVer string | [View](https://glitchtip.devshift.net/ccx/issues/4472539) |
| #4472549 | 3 | ValueError: 4.3 is not valid SemVer string | [View](https://glitchtip.devshift.net/ccx/issues/4472549) |
| #4472541 | 9 | ValueError: 4.7 is not valid SemVer string | [View](https://glitchtip.devshift.net/ccx/issues/4472541) |
| #4471405 | 3 | ValueError: 4.23 is not valid SemVer string | [View](https://glitchtip.devshift.net/ccx/issues/4471405) |

**Recommendation:** Consider merging into [#3979080](https://glitchtip.devshift.net/ccx/issues/3979080) (highest event count)
...
| Issue ID | Events | Title | Link |
|----------|--------|-------|------|
| #4129705 | 106 | Error: kafka server: Tried to send a message to a replica... | [View](https://glitchtip.devshift.net/ccx/issues/4129705) |
| #4129707 | 106 | Error: kafka server: Tried to send a message to a replica... | [View](https://glitchtip.devshift.net/ccx/issues/4129707) |
...
| Issue ID | Events | Title | Link |
|----------|--------|-------|------|
| #4129671 | 89 | Error: kafka server: Tried to send a message to a replica... | [View](https://glitchtip.devshift.net/ccx/issues/4129671) |
| #4129668 | 89 | Error: kafka server: Tried to send a message to a replica... | [View](https://glitchtip.devshift.net/ccx/issues/4129668) |
...
| Issue ID | Events | Title | Link |
|----------|--------|-------|------|
| #3791585 | 3,885 | AttributeError: 'str' object has no attribute 'parent' | [View](https://glitchtip.devshift.net/ccx/issues/3791585) |
| #3781153 | 5,041 | AttributeError: 'NoneType' object has no attribute 'start... | [View](https://glitchtip.devshift.net/ccx/issues/3781153) |
...
| Issue ID | Events | Title | Link |
|----------|--------|-------|------|
| #4319956 | 963 | ParseException: ccx_ocp_core.parsers.insights_operator.co... | [View](https://glitchtip.devshift.net/ccx/issues/4319956) |
...
| Issue ID | Events | Title | Link |
|----------|--------|-------|------|
| #4471408 | 12 | ValueError: xyz is not valid SemVer string | [View](https://glitchtip.devshift.net/ccx/issues/4471408) |
| #4472538 | 12 | ValueError: 4.21 is not valid SemVer string | [View](https://glitchtip.devshift.net/ccx/issues/4472538) |
| #4472550 | 6 | ValueError: 4.3 is not valid SemVer string | [View](https://glitchtip.devshift.net/ccx/issues/4472550) |
| #4472543 | 18 | ValueError: 4.7 is not valid SemVer string | [View](https://glitchtip.devshift.net/ccx/issues/4472543) |
| #4471404 | 6 | ValueError: 4.23 is not valid SemVer string | [View](https://glitchtip.devshift.net/ccx/issues/4471404) |

**Recommendation:** Consider merging into [#4471408](https://glitchtip.devshift.net/ccx/issues/4471408) (highest event count)

---

### 🟢 LOW: InvalidArchive: Cannot detect execution context: No files in path: /tmp/insig...

**Issues:** 126 | **Total Events:** 0
...
| #4472430 | 1 | InvalidArchive: Cannot detect execution context: No files... | [View](https://glitchtip.devshift.net/ccx/issues/4472430) |
| #4472396 | 1 | InvalidArchive: Cannot detect execution context: No files... | [View](https://glitchtip.devshift.net/ccx/issues/4472396) |
| #4472394 | 1 | InvalidArchive: Cannot detect execution context: No files... | [View](https://glitchtip.devshift.net/ccx/issues/4472394) |
| #4472393 | 1 | InvalidArchive: Cannot detect execution context: No files... | [View](https://glitchtip.devshift.net/ccx/issues/4472393) |
| #4472392 | 1 | InvalidArchive: Cannot detect execution context: No files... | [View](https://glitchtip.devshift.net/ccx/issues/4472392) |
| #4472391 | 1 | InvalidArchive: Cannot detect execution context: No files... | [View](https://glitchtip.devshift.net/ccx/issues/4472391) |
| #4472386 | 1 | InvalidArchive: Cannot detect execution context: No files... | [View](https://glitchtip.devshift.net/ccx/issues/4472386) |
| #4472384 | 1 | InvalidArchive: Cannot detect execution context: No files... | [View](https://glitchtip.devshift.net/ccx/issues/4472384) |
| #4472383 | 1 | InvalidArchive: Cannot detect execution context: No files... | [View](https://glitchtip.devshift.net/ccx/issues/4472383) |
| #4472381 | 1 | InvalidArchive: Cannot detect execution context: No files... | [View](https://glitchtip.devshift.net/ccx/issues/4472381) |
| #4472380 | 1 | InvalidArchive: Cannot detect execution context: No files... | [View](https://glitchtip.devshift.net/ccx/issues/4472380) |
| #4472379 | 1 | InvalidArchive: Cannot detect execution context: No files... | [View](https://glitchtip.devshift.net/ccx/issues/4472379) |
| #4472378 | 1 | InvalidArchive: Cannot detect execution context: No files... | [View](https://glitchtip.devshift.net/ccx/issues/4472378) |
| #4472375 | 1 | InvalidArchive: Cannot detect execution context: No files... | [View](https://glitchtip.devshift.net/ccx/issues/4472375) |
| #4472373 | 1 | InvalidArchive: Cannot detect execution context: No files... | [View](https://glitchtip.devshift.net/ccx/issues/4472373) |
| #4472372 | 1 | InvalidArchive: Cannot detect execution context: No files... | [View](https://glitchtip.devshift.net/ccx/issues/4472372) |
| #4472371 | 1 | InvalidArchive: Cannot detect execution context: No files... | [View](https://glitchtip.devshift.net/ccx/issues/4472371) |
| #4472370 | 1 | InvalidArchive: Cannot detect execution context: No files... | [View](https://glitchtip.devshift.net/ccx/issues/4472370) |
| #4472368 | 1 | InvalidArchive: Cannot detect execution context: No files... | [View](https://glitchtip.devshift.net/ccx/issues/4472368) |
| #4472366 | 1 | InvalidArchive: Cannot detect execution context: No files... | [View](https://glitchtip.devshift.net/ccx/issues/4472366) |
| #4472365 | 1 | InvalidArchive: Cannot detect execution context: No files... | [View](https://glitchtip.devshift.net/ccx/issues/4472365) |
| #4472364 | 1 | InvalidArchive: Cannot detect execution context: No files... | [View](https://glitchtip.devshift.net/ccx/issues/4472364) |
| #4472362 | 1 | InvalidArchive: Cannot detect execution context: No files... | [View](https://glitchtip.devshift.net/ccx/issues/4472362) |
| #4472361 | 1 | InvalidArchive: Cannot detect execution context: No files... | [View](https://glitchtip.devshift.net/ccx/issues/4472361) |
| #4472360 | 1 | InvalidArchive: Cannot detect execution context: No files... | [View](https://glitchtip.devshift.net/ccx/issues/4472360) |
| #4471712 | 1 | InvalidArchive: Cannot detect execution context: No files... | [View](https://glitchtip.devshift.net/ccx/issues/4471712) |
...
| Issue ID | Events | Title | Link |
|----------|--------|-------|------|
| #4129669 | 40 | Error: kafka server: Tried to send a message to a replica... | [View](https://glitchtip.devshift.net/ccx/issues/4129669) |
| #4129667 | 40 | Error: kafka server: Tried to send a message to a replica... | [View](https://glitchtip.devshift.net/ccx/issues/4129667) |

**Recommendation:** Consider merging into [#4129669](https://glitchtip.devshift.net/ccx/issues/4129669) (highest event count)

---

### 🟢 LOW: kafka: error while consuming ccx.ocp.results/0: dial tcp ...: connect: connec...
...
| #4434850 | 8 | kafka: error while consuming ccx.ocp.results/0: dial tcp ... | [View](https://glitchtip.devshift.net/ccx/issues/4434850) |
| #4491661 | 1 | kafka: error while consuming ccx.ocp.results/0: dial tcp ... | [View](https://glitchtip.devshift.net/ccx/issues/4491661) |

**Recommendation:** Consider merging into [#4506736](https://glitchtip.devshift.net/ccx/issues/4506736) (highest event count)
